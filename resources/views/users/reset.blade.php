    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form action="{{ route('forget.update') }}" method="POST">
                ...
                <input type="text" id="User" class="fadeIn second" name="password" placeholder="Password">
                @error('password')
                    <p class="error">{{ $message }}</p>
                @enderror
                <input type="text" id="password" class="fadeIn third" name="password_confirmation"
